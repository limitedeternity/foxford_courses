...
def theory_screenshot(driver, lesson_name, info):
    file = str(lesson_name) + "_" + str(info).replace('"', '') + ".png"
...
def homework_screenshot(driver, lesson_name, task_name, state):
    file = str(lesson_name) + "_" + str(task_name).replace('"', '') + "_" + state + ".png"
